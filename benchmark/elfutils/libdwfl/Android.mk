...
LOCAL_CFLAGS += -DHAVE_CONFIG_H -std=gnu99 -D_GNU_SOURCE -Wno-error
...
# See above.
LOCAL_CFLAGS += -Wno-unused-but-set-variable
LOCAL_CFLAGS += -Wno-unused-variable -Wno-implicit-function-declaration
LOCAL_CFLAGS += -Wno-unused-function
LOCAL_MODULE:= libdwfl

LOCAL_EXPORT_C_INCLUDE_DIRS := $(LOCAL_PATH)

LOCAL_STATIC_LIBRARIES := libz libelf
